package org.cbs.actions.data;

import static org.cbs.enums.ListenerType.TEST_DATA_ACTION;
import static org.cbs.manager.ParallelSession.getSession;
import static org.cbs.parser.DataFactory.getParser;
import static org.cbs.utils.Validator.checkIndex;
...
import org.cbs.actions.interfaces.data.IDataRow;
import org.cbs.actions.interfaces.data.ITestDataAction;
import org.cbs.actions.interfaces.listeners.data.ITestDataActionsListener;
import org.cbs.parser.IDataParser;
