...
import static org.cbs.enums.ListenerType.DEVICE_ACTION;
import static org.cbs.enums.Message.NO_KEYBOARD_ERROR;
...
import static org.cbs.utils.VideoUtil.saveVideo;
...
import org.cbs.actions.interfaces.device.IDeviceActions;
import org.cbs.actions.interfaces.listeners.device.IDeviceActionsListener;
import org.cbs.config.ui.mobile.device.VideoSetting;
